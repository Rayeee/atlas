package com.eparty.ccp.core.util.validate.function;
...
public class ValidateHelper {
    ...
    private static final ServiceException NULL_EXCEPTION = new ServiceException("Target can not be null!");
    ...
    public static <T, E extends Throwable> void validate(T dto) throws ServiceException {
        validate(dto, DEFAULT_IS_DEEP);
    }

    public static <T, E extends Throwable> void validate(T dto, boolean isDeep) throws ServiceException {
     ...
     * @param <E>            自定义异常
     */
    public static <T, E extends ServiceException> void validate(T bean, boolean isDeep, boolean forceException, E exception) throws ServiceException {
    ...
    //validate
    private static final <T, E extends ServiceException> void validateNull(T bean, boolean isDeep, boolean forceException, E exception) throws ServiceException {
        if (isDeep) {
            notNull(exception);
        }
        notNull(bean);
    ...
    private static <E> void notNull(E bean) throws ServiceException {
